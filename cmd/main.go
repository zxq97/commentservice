...
func main() {
	...
	global.InfoLog, err = conf.InitLog(CommentConf.LogPath.Info)
	if err != nil {
		panic(err)
	}
	global.ExcLog, err = conf.InitLog(CommentConf.LogPath.Exc)
	if err != nil {
		panic(err)
	}
	global.DebugLog, err = conf.InitLog(CommentConf.LogPath.Debug)
	if err != nil {
		panic(err)
	}
